...
Revision ID: a165aa988b0b
Revises: 
Create Date: 2021-08-16 11:28:56.743628
...
def upgrade():
    ...
    sa.Column('amount', postgresql.MONEY(), nullable=False, comment='Amount for which this discount is applicable.'),
